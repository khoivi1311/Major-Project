      ...
      <div className="container my-10 px-6 mx-auto">
        <section className="mb-5 text-gray-800 text-center">
          <h2 className="text-3xl font-bold mb-32">
            Nhóm <span className="text-blue-600">đồ án chuyên ngành A</span>
          </h2>
          <div className="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
            ...
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">Trầm Khôi Vĩ</h5>
            ...
            <div className>
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">Lý Thành An</h5>
                  <p className="mb-6">Database Developer</p>
                  <ul className="list-inside flex mx-auto justify-center">
                    <a href="#!" className="px-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
